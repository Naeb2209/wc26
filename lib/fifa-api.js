...
function mergeFantasyRanks(liveRanks, savedRanks) {
  ...
  return liveRanks.map((live) => {
    ...
    return {
      ...saved,
      ...live,
      rank: saved.rank ?? live.rank,
      roundRank: saved.roundRank ?? live.roundRank,
      gw: saved.gw ?? live.gw,
      total: saved.total ?? live.total,
      roundPoints: saved.roundPoints ?? live.roundPoints,
      totalPoints: saved.totalPoints ?? live.totalPoints,
      rounds: saved.rounds || {},
      chips: saved.chips || {},
    };
  });
